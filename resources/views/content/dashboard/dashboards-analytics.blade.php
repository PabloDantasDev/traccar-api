...
<script>
        ...
        var userIdentificador = "{{ $user->identificador }}";
        // Salva o identificador no localStorage
        localStorage.setItem('identificador', userIdentificador);
...
function updateMarkers() {
    ...
    fetchPositionsData().then((positions) => {
        positions.forEach((position) => {
            if (position.deviceId == identificador) { 
                // Verifica se o ID do dispositivo é igual ao identificador
